...
import Java8.exeptions.PhoneNumberExceptions;
...
public class Main {
    public static <PhoneNumberExcaption> void main(String[] args)  {
        try {


            Scanner scanner = new Scanner(System.in);
            Car car1 = new Car("aristo", "toyota", new BigDecimal(3000), Year.of(1996), Colour.BLUE, Country.GERMANY);
            Car car2 = new Car("e39", "BMW", new BigDecimal(6000), Year.of(2005), Colour.RED, Country.GERMANY);
            Car car3 = new Car("primera", "nissan", new BigDecimal(3000), Year.of(1990), Colour.RED, Country.GERMANY);
            Car car4 = new Car("mark 2", "TOYOTA", new BigDecimal(2000), Year.of(1993), Colour.WHITE, Country.JAPAN);
            Car car5 = new Car("x5", "BMW", new BigDecimal(3000), Year.of(2000), Colour.BLUE, Country.USA);
            Car car6 = new Car("lx570", "lexus", new BigDecimal(3000000), Year.of(1996), Colour.BLUE, Country.GERMANY);
            ...
            Car car9 = new Car("tico", "DEWO", new BigDecimal(3000), Year.of(1996), Colour.BLUE, Country.KYRGYZSTAN);
            Car car10 = new Car("amg", "mercedes", new BigDecimal(300), Year.of(1996), Colour.BLUE, Country.KYRGYZSTAN);
            ...
            Person person1 = new Person("Nurlan", LocalDate.of(2004, 6, 11), Gender.MALE, new BigDecimal(300000)
                    , "+996704830452", carsKutman);
            Person person2 = new Person("Aibek", LocalDate.of(1996, 3, 23), Gender.MALE, new BigDecimal(9000),
                    "+996707845236", carsBakas);
            Person person3 = new Person("Aisuluu", LocalDate.of(1995, 3, 24), Gender.FEMALE, new BigDecimal(12000),
                    "+996706982546", carsAiperi);
            ...
            while (true) {
                ...
                switch (swith) {
                    ...
                    case 13:
                        ...
                        System.out.println(carService.findByCountry(scanner.nextLine(), people));
                        break;
                    default:
